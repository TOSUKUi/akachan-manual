...
sources:
  ...
  - name: 西松屋 はじめてのベビーウェア（サイズ表・参考月齢つき）
    ...
    checked: "2026-09-02"
  - name: 西松屋オンラインストア 60cmサイズ商品一覧
    url: https://www.24028-net.jp/category/S85/
    checked: "2026-09-02"
support:
  - id: yobou-suii
    title: 予防接種のスケジュール確認
  ...
  - id: m23-detergent
    ...
    shops:
      ...
      - kind: akachan
        q: 洗剤
  - id: m23-size60
    name: 服・肌着の買い足し（60サイズ）
    category: kiru
    need: useful
    startMonth: 2
    endMonth: 8
    size: 60cm／西松屋サイズ表の参考月齢は3か月前後
    note: 50cm（新生児）は袖も股も2〜3か月で窮屈になります。サイズ表の参考月齢はあくまで目安で、早めに着られなくなる側から1サイズ上げるだけ。西松屋の目安は肌着5〜6枚・衣類3〜4枚なので、全部をそろえ直す必要はなく、小さいサイズ分だけ買い足します（目安 2〜3点）
    whySources:
    ...
    price:
      ...
      checked: "2026-09-02"
      sources:
        - https://www.24028-net.jp/category/S85/
    shops:
      - kind: nishimatyaya
        q: 60cm 肌着
      - kind: akachan
