...
support:
  ...
  - id: hoiku-nyuen-yoyaku
    ...
    detail: 4月一括入所の受付は例年10月下旬から11月中旬で、申込書の提出順ではなく、申請期間内に出したものは同一順位として不足数に応じて調整選考します。内定は2月上旬、入園準備は2〜3月。区の児童福祉課ページからダウンロードできる「入園のしおり」に、申込書類（指数計算シートなど）と持ち回り保育の仕組みが載っています。
